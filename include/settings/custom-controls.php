...
if (class_exists('WP_Customize_Control')) {
	 ...
	 */
	class WebArch_Custom_Control extends WP_Customize_Control {
		...
		protected function get_WebArch_resource_url() {
			return trailingslashit(WA_THEME_URI)."include/settings/";
		}
	}
	 ...
	 * @link https://github.com/maddisondesigns
	 */
	class WebArch_Custom_Section extends WP_Customize_Section {
		protected $skyrocketCustomControlsCssVersion = '1.3';
		protected $skyrocketCustomControlsJsVersion = '1.2';
		protected function get_WebArch_resource_url() {
            return trailingslashit(wp_normalize_path(__DIR__));
		}

	}

    class WebArch_Container_Custom_Control extends WebArch_Custom_Control {
        /**
        ...
        public function enqueue() {
            wp_enqueue_style('skyrocket-custom-controls-css', $this->get_WebArch_resource_url() . 'assets/css/customizer.css', array(), $this->skyrocketCustomControlsCssVersion, 'all');
            wp_enqueue_script('skyrocket-custom-controls-js', $this->get_WebArch_resource_url() . 'assets/js/customizer.js', array('jquery'), $this->skyrocketCustomControlsJsVersion, true);
        }
        /**
        ...
        public function render_content() {
            ?>
            <div class="wa-customizer-container-control">
                <h3>
                    <?= $this->label ?>
                </h3>
            </div>
	 ...
	 * @link https://github.com/maddisondesigns
	 */
	 class WebArch_Image_Checkbox_Custom_Control extends WebArch_Custom_Control {
		/**
		 * The type of control being rendered
		 */
	 ...
	 * @link https://github.com/maddisondesigns
	 */
	 class WebArch_Text_Radio_Button_Custom_Control extends WebArch_Custom_Control {
		/**
		 * The type of control being rendered
		 */
		 ...
		 */
		public function render_content() {
            $toggles = explode(',', $this->value());
            for($i = 0; $i < count($toggles); $i++)
                $toggles[$i] = explode(":", $toggles[$i]);
		?>
				...
				<div class="radio-buttons">
					<?php foreach ($toggles as $toggle) {
                        ...
                        foreach ($toggles as $t)
                            $value .= (empty($value) ? "" : ",").$t[0].":".($t == $toggle ? 1 : 0);
                        ?>
						<label class="radio-button-label">
							<input type="radio" name="<?= esc_attr($this->id); ?>" value="<?= $value ?>" <?php $this->link(); ?> <?= checked($checked) ?>/>
	 ...
	 * @link https://github.com/maddisondesigns
	 */
	class WebArch_Image_Radio_Button_Custom_Control extends WebArch_Custom_Control {
		/**
		 * The type of control being rendered
		 */
	 ...
	 * @link https://github.com/maddisondesigns
	 */
	class WebArch_Single_Accordion_Custom_Control extends WebArch_Custom_Control {
		/**
		 * The type of control being rendered
		 */
	 ...
	 * @link https://github.com/maddisondesigns
	 */
	class WebArch_Simple_Notice_Custom_Control extends WebArch_Custom_Control {
		/**
		 * The type of control being rendered
		 */
	 ...
	 * @link https://github.com/maddisondesigns
	 */
	class WebArch_Slider_Custom_Control extends WebArch_Custom_Control {
		/**
		 * The type of control being rendered
		 */
		 ...
		 */
		public function enqueue() {
			wp_enqueue_script('skyrocket-custom-controls-js', $this->get_WebArch_resource_url() . 'assets/js/customizer.js', array('jquery', 'jquery-ui-core'), $this->skyrocketCustomControlsJsVersion, true);
			wp_enqueue_style('skyrocket-custom-controls-css', $this->get_WebArch_resource_url() . 'assets/css/customizer.css', array(), $this->skyrocketCustomControlsCssVersion, 'all');
		}
		/**
		 * Render the control in the customizer
	 ...
	 * @link https://github.com/maddisondesigns
	 */
	class WebArch_Toggle_Switch_Custom_Control extends WebArch_Custom_Control {
		/**
		 * The type of control being rendered
		 */
		...
		?>
			<div class="toggle-switch-control">
				...
				<div class="toggle-switch">
					<input type="checkbox" id="<?php echo esc_attr($this->id); ?>" name="<?php echo esc_attr($this->id); ?>" class="toggle-switch-checkbox" <?php $this->link(); checked($this->value()); ?>>
     ...
     * @link https://github.com/maddisondesigns
     */
    class WebArch_Toggle_Switch_Text_Custom_Control extends WebArch_Custom_Control {
        /**
         * The type of control being rendered
         */
        public $type = 'toggle_switch_text';
         ...
         */
        public function render_content(){
            $val_obj = json_decode($this->value());
            if(empty($val_obj))
                $val_obj = (object)array("text" => "", "act" => true);
            ?>
            <div class="toggle-switch-control toggle-switch-text-control">
                <span class="customize-control-title"><?php echo esc_html($this->label); ?></span>
                <div class="toggle-switch">
                    <input type="checkbox" id="<?php echo esc_attr($this->id)."_checkbox"; ?>" class="toggle-switch-checkbox" <?php echo $val_obj->act ? " checked " : ""; ?>>
                    <label class="toggle-switch-label" for="<?php echo esc_attr($this->id)."_checkbox"; ?>">
                        <span class="toggle-switch-inner"></span>
                        <span class="toggle-switch-switch"></span>
                    </label>
                </div>
                <div style="grid-column:1/3;">
                    <div class="example">itemscope&nbsp;itemtype=<br>"https://schema.org/<b><?= empty($val_obj) ? $val_obj->placeholder : $val_obj->text ?></b>":</div>
                    <input type="text" placeholder="<?= $val_obj->placeholder ?? "" ?>" id="<?php echo esc_attr($this->id)."_text"; ?>" value="<?php echo esc_attr($val_obj->text); ?>">
	 ...
	 * @link https://github.com/maddisondesigns
	 */
	class WebArch_Sortable_Repeater_Custom_Control extends WebArch_Custom_Control {
		/**
		 * The type of control being rendered
		 */
	 ...
	 * @link https://github.com/maddisondesigns
	 */
	class WebArch_Dropdown_Select2_Custom_Control extends WebArch_Custom_Control {
		/**
		 * The type of control being rendered
		 */
		 ...
		 */
		public function enqueue() {
			wp_enqueue_script('skyrocket-select2-js', $this->get_WebArch_resource_url() . 'assets/js/select2.full.min.js', array('jquery'), '4.0.13', true);
			wp_enqueue_script('skyrocket-custom-controls-js', $this->get_WebArch_resource_url() . 'assets/js/customizer.js', array('skyrocket-select2-js'), $this->skyrocketCustomControlsJsVersion, true);
			wp_enqueue_style('skyrocket-custom-controls-css', $this->get_WebArch_resource_url() . 'assets/css/customizer.css', array(), $this->skyrocketCustomControlsCssVersion, 'all');
			wp_enqueue_style('skyrocket-select2-css', $this->get_WebArch_resource_url() . 'assets/css/select2.min.css', array(), '4.0.13', 'all');
		}
		/**
		 * Render the control in the customizer
		 */
	 ...
	 * @link https://github.com/maddisondesigns
	 */
	class WebArch_Dropdown_Posts_Custom_Control extends WebArch_Custom_Control {
		/**
		 * The type of control being rendered
		 */
	 ...
	 * @link https://github.com/maddisondesigns
	 */
	class WebArch_TinyMCE_Custom_Control extends WebArch_Custom_Control {
		/**
		 * The type of control being rendered
		 */
	 ...
	 * @link https://github.com/maddisondesigns
	 */
	class WebArch_Google_Font_Select_Custom_Control extends WebArch_Custom_Control {
		/**
		 * The type of control being rendered
		 */
		...
		public function __construct($manager, $id, $args = array(), $options = array()) {
			...
			$this->fontList = $this->WebArch_getGoogleFonts('all');
			// Decode the default json font value
			$this->fontValues = json_decode($this->value());
			// Find the index of our default font within our list of Google fonts
			$this->fontListIndex = $this->WebArch_getFontIndex($this->fontList, $this->fontValues->font);
		}
		/**
		 * Enqueue our scripts and styles
		 */
		 ...
		 */
		public function WebArch_getFontIndex($haystack, $needle) {
		 ...
		 */
		public function WebArch_getGoogleFonts($count = 30) {
			// Google Fonts json generated from https://www.googleapis.com/webfonts/v1/webfonts?sort=popularity&key=YOUR-API-KEY
			$fontFile = $this->get_WebArch_resource_url() . 'google-fonts-alphabetical.json';
			if ($this->fontOrderBy === 'popular') {
				$fontFile = $this->get_WebArch_resource_url() . 'google-fonts-popularity.json';
			}
	 ...
	 */
	class WebArch_Customize_Alpha_Color_Control extends WebArch_Custom_Control {
		/**
		 * The type of control being rendered
		 */
		 ...
		 */
		public function enqueue() {
			wp_enqueue_script('skyrocket-custom-controls-js', $this->get_WebArch_resource_url() . 'assets/js/customizer.js', array('jquery', 'wp-color-picker'), $this->skyrocketCustomControlsJsVersion, true);
			wp_enqueue_style('skyrocket-custom-controls-css', $this->get_WebArch_resource_url() . 'assets/css/customizer.css', array('wp-color-picker'), $this->skyrocketCustomControlsCssVersion, 'all');
		}
		/**
		 * Render the control in the customizer
		 */
	 ...
	 */
	class WebArch_Alpha_Color_Control extends WebArch_Custom_Control {
		/**
		 * The type of control being rendered
		 */
		 ...
		 */
		public function enqueue() {
			wp_enqueue_script('wp-color-picker-alpha', $this->get_WebArch_resource_url() . 'assets/js/wp-color-picker-alpha-min.js', array('wp-color-picker'), '3.0.2', true);
			wp_enqueue_script('skyrocket-custom-controls-js', $this->get_WebArch_resource_url() . 'assets/js/customizer.js', array('jquery', 'wp-color-picker-alpha'), $this->skyrocketCustomControlsJsVersion, true);
			wp_enqueue_style('skyrocket-custom-controls-css', $this->get_WebArch_resource_url() . 'assets/css/customizer.css', array(), $this->skyrocketCustomControlsCssVersion, 'all');
	 ...
	 * @link https://github.com/maddisondesigns
	 */
	class WebArch_Pill_Checkbox_Custom_Control extends WebArch_Custom_Control {
		/**
		 * The type of control being rendered
		 */
		...
		public function render_content() {
			...
			$saved_pairs = explode(',', esc_attr($this->value()));
            $saved_choices = [];
            for($i = 0; $i < count($saved_pairs); $i++) {
                $pair = explode(":", $saved_pairs[$i]);
                $saved_choices[$pair[0]] = $pair[1] == 1;
            }

			// Order the checkbox choices based on the saved order
			if($this->sortable) {
				foreach ($saved_choices as $key => $val) {
					if(array_key_exists($key, $this->choices))
						$reordered_choices[$key] = $this->choices[$key];
				}
		...
		?>
			<div class="pill_checkbox_control">
				...
				<?php foreach ($reordered_choices as $key => $value) { ?>
					<label class="checkbox-label">
						<input type="checkbox" name="<?php echo esc_attr($key); ?>" value="<?php echo esc_attr($key); ?>" <?php checked(array_key_exists($key, $saved_choices) && $saved_choices[$key]); ?> class="sortable-pill-checkbox"/>
    ...
    class WebArch_Pill_Checkbox_Advanced_Custom_Control extends WebArch_Pill_Checkbox_Custom_Control{
        public function render_content() {
            $reordered_choices = array();
            ...
            if($this->sortable) {
                ...
                foreach($this->choices as $key => $val){
                    if(!isset($reordered_choices[$key])) {
                        $reordered_choices[$key] = ["label" => $val, "checked" => true];
                    }
                }
            }
            else {
            ...
            ?>
            <div class="pill_checkbox_control pill_checkbox_advanced_control">
                <?php if(!empty($this->label)) { ?>
                    <span class="customize-control-title"><?php echo esc_html($this->label); ?></span>
                <?php } ?>
                <?php if(!empty($this->description)) { ?>
                ...
                <div class="sortable_pills<?php echo ($this->sortable ? ' sortable' : '') . ($this->fullwidth ? ' fullwidth_pills' : ''); ?>">
                    <?php foreach ($reordered_choices as $key => $value) {
                        ...
                        if(is_array($value)){
                            $label = $value["label"] ?? "";
                            $sortable = $value["sortable"] ?? $this->sortable;
                            $classes = $value["class"] ?? $value["classes"] ?? "";
                            $checked = $value["checked"] ?? false;
                            $classes = (empty($classes) ? "" : " ").$classes;
                            $metaitem = preg_match("/(^| )metaitem( |$)/ui", $classes) === 1;
                        }
                        ?>
                        <label class="checkbox-label<?= !$sortable ? " unsortable" : ""?><?= $classes ?>">
                            <input type="checkbox" name="<?php echo esc_attr($key); ?>" value="<?php echo esc_attr($key); ?>" <?= $metaitem ? "disabled" : "" ?> <?php checked($metaitem || $checked); ?> class="sortable-pill-checkbox"/>
                            <span class="sortable-pill-title"><?php echo esc_attr($label); ?></span>
                            <?php if($sortable && $this->fullwidth) { ?>
                                <span class="dashicons dashicons-sort"></span>
                            <?php } ?>
                        </label>
                    <?php	} ?>
	 ...
	 * @link https://github.com/maddisondesigns
	 */
	class WebArch_Divider_Custom_Control extends WebArch_Custom_Control {
		/**
		 * The type of control being rendered
		 */
		...
		public function render_content() {
            ...
            if($this->marginbottom >= 0)
                $style .= "margin-top: ".$this->marginbottom."px";
            if(!empty($style))
                $style = "style=\"$style\"";
		?>
			<div class="simple-divider-custom-control simple-divider-type-<?php echo $this->dividertype; ?> simple-divider-width-<?php echo $this->dividerwidth; ?>" <?= $style ?>></div>
		<?php
		}
	}
	 ...
	 *
	 */
	class WebArch_Upsell_Section extends WebArch_Custom_Section {
		/**
		 * The type of control being rendered
		 */
		...
		protected function render() {
			...
			?>
			<li id="accordion-section-<?php echo esc_attr($this->id); ?>" class="WebArch_upsell_section accordion-section control-section control-section-<?php echo esc_attr($this->id); ?> cannot-expand">
    ...
    //class WebArch_Just_Current_Page_Custom_Control extends WebArch_Custom_Control {
        /**
         * The type of control being rendered
         */
       // public $type = 'just_current_page';
        /**
         * Enqueue our scripts and styles
         */
       /* public function enqueue() {
        ...
        /*public function render_content() {
            ?>
                <div class="just_current_page">
                    ...
                    <div class="toggler">
                        <div class="toggle-switch">
                            <input type="checkbox" id="just_current_page" name="<?php echo esc_attr($this->id); ?>" class="toggle-switch-checkbox" <?php $this->link(); ?>>
                            <label class="toggle-switch-label" for="just_current_page">
                                <span class="toggle-switch-inner"></span>
                                <span class="toggle-switch-switch"></span>
                            </label>
                        </div>
	 ...
	 */
	if (! function_exists('WebArch_url_sanitization')) {
		function WebArch_url_sanitization($input) {
	 ...
	 */
	if (! function_exists('WebArch_switch_sanitization')) {
		function WebArch_switch_sanitization($input) {
			if (true === $input) {
				return 1;
			} else {
				return 0;
	 ...
	 * @return integer	Sanitized value
	 */
	if (! function_exists('WebArch_radio_sanitization')) {
		function WebArch_radio_sanitization($input, $setting) {
	 ...
	 */
	if (! function_exists('WebArch_sanitize_integer')) {
		function WebArch_sanitize_integer($input) {
			return (int) $input;
		}
	}
	 ...
	 * @return string	Sanitized input
	 */
	if (! function_exists('WebArch_text_sanitization')) {
		function WebArch_text_sanitization($input) {
			if (strpos($input, ',') !== false) {
				$input = explode(',', $input);
			}
			if(is_array($input)) {
	 ...
	 */
	if (! function_exists('WebArch_array_sanitization')) {
		function WebArch_array_sanitization($input) {
			if(is_array($input)) {
				foreach ($input as $key => $value) {
					$input[$key] = sanitize_text_field($value);
				}
	 ...
	 * @return string	Sanitized input
	 */
	if (! function_exists('WebArch_hex_rgba_sanitization')) {
		function WebArch_hex_rgba_sanitization($input, $setting) {
			...
			if (false === strpos($input, 'rgb')) {
				...
				if (false === strpos($input, 'rgba')) {
					...
					$input = 'rgb(' . WebArch_in_range($red, 0, 255) . ',' . WebArch_in_range($green, 0, 255) . ',' . WebArch_in_range($blue, 0, 255) . ')';
				}
				else {
					// Sanitize as RGBa color
					$input = str_replace(' ', '', $input);
					sscanf($input, 'rgba(%d,%d,%d,%f)', $red, $green, $blue, $alpha);
					$input = 'rgba(' . WebArch_in_range($red, 0, 255) . ',' . WebArch_in_range($green, 0, 255) . ',' . WebArch_in_range($blue, 0, 255) . ',' . WebArch_in_range($alpha, 0, 1) . ')';
				}
			}
			return $input;
		}
	 ...
	 */
	if (! function_exists('WebArch_in_range')) {
		function WebArch_in_range($input, $min, $max){
			if ($input < $min) {
				$input = $min;
			}
			if ($input > $max) {
	 ...
	 * @return string	Sanitized input
	 */
	if (! function_exists('WebArch_google_font_sanitization')) {
		function WebArch_google_font_sanitization($input) {
	 ...
	 * @return string	Sanitized input
	 */
	if (! function_exists('WebArch_date_time_sanitization')) {
		function WebArch_date_time_sanitization($input, $setting) {
	 ...
	 * @return string	Sanitized input
	 */
	if (! function_exists('WebArch_range_sanitization')) {
		function WebArch_range_sanitization($input, $setting) {
			...
			return WebArch_in_range($number, $min, $max);
		}
	}
