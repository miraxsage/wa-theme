...
class WaToggleCheckbox extends Component {
    ...
    constructor(props) {
        super(props);
        this.id = props.id;
        if (!props.id) this.id = generateId();
    }
    componentDidMount() {
    ...
    render() {
        ...
        return (
            <div ref={this.rootRef} className="wa-toggle" style={style}>
                <div className="wa-toggle__header">
                    {withoutHeader ? null : (
                        <WaOptionsButton
                            ...
                            context={context}
                            style={{
                                margin: hideOptions ? "0px" : "0px 4px 0px 0px",
                                position: "relative",
                                top: "1px",
                            }}
                        />
                    ...
                    <label
                        ...
                        style={{ margin: "0px", padding: "1px 0px 0px 0px" }}
                    >
                        {field.label}
                    </label>
                ...
                {field.description ? (
                    <em className="cf-field__help wa-toggle__description">
                        {field.description}
                    </em>
                ) : (
                    ""
