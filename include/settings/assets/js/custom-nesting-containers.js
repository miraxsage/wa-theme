(function($) {
    ...
    api.bind('pane-contents-reflowed', function() {
        ...
        api.section.each(function(section) {
            if (
                'wa_section' !== section.params.type ||
        ...
        attachEvents: function() {
            ...
            section.container.find('.customize-section-back')
                ...
                .on('click keydown', function(event) {
                    ...
                    event.preventDefault(); // Keep this AFTER the key filter above
                    if (section.expanded()) {
                        $("body").addClass("customizing_without_transions");
                        api.section(section.params.section).expand({completeCallback: function(){
                                $("body").removeClass("customizing_without_transions");
                            }});
                    }
                    return false;
                });
